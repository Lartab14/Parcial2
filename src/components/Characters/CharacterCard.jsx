...
function CharacterCard({ character, darkMode, onHover }) {
  ...
  return (
    <div
      className={`character-card ${darkMode ? 'dark-mode' : ''}`}
      onClick={handleClick}
    ...
    >
      ...
      <div className="character-info">
        ...
        {character.occupation && <p><strong>Ocupación:</strong> {character.occupation}</p>}
      </div>
    </div>
  );
}
